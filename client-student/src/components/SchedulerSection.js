...
const StudentDashboard = ({ studentData }) => {
  ...
  // Navigation items
  const navItems = [
    { id: 'dashboard', icon: '📊', label: 'Dashboard', component: <DashboardHome studentData={studentData} /> },
    { id: 'academics', icon: '📚', label: 'Academic Records', component: <AcademicSection studentData={studentData} /> },
    { id: 'documents', icon: '📄', label: 'Online Documents', component: <DocumentsSection studentData={studentData} /> },
    { id: 'scheduler', icon: '📅', label: 'Request Scheduler', component: <SchedulerSection /> },
    { id: 'applications', icon: '📋', label: 'Applications', component: <ApplicationsSection /> },
    { id: 'profile', icon: '👤', label: 'My Profile', component: <ProfileSection studentData={studentData} /> },
    { id: 'settings', icon: '⚙️', label: 'Account Settings', component: <SettingsSection darkMode={darkMode} toggleDarkMode={toggleDarkMode} /> },
    { id: 'resources', icon: '🏛️', label: 'Campus Resources', component: <ResourcesSection /> },
  ];
      ...
      <div className="sidebar">
        <div className="sidebar-header">
          <div className="logo-section">
            ...
            <span className="college-name">Pateros Technological College</span>
          </div>
...
// Enhanced Dashboard Home Component with Widgets
    ...
    <div className="dashboard-home">
        ...
        <div className="widget-customizer">
          ...
          <div className="widget-options">
            {Object.keys(customizableWidgets).map(widgetKey => (
              <label key={widgetKey} className="widget-option">
                <input
                  type="checkbox"
      ...
      <div className="quick-actions-grid">
        ...
        <div className="action-card secondary">
          ...
          <p>Track your applications and submission requirements</p>
...
// Enhanced Academic Section with Document Printing
    ...
    <div className="section-content">
      ...
      <div className="documents-section">
        ...
        <div className="printing-info">
          ...
          <ul>
            <li>Documents are generated in PDF format</li>
            <li>Use legal size paper for official documents</li>
            <li>Keep a copy for your records</li>
            <li>Allow 2-3 business days for document processing</li>
          </ul>
        </div>
      </div>
    </div>
...
// New Documents Section Component
...
// New Scheduler Section Component
...
// Enhanced Settings Section with Theme Toggle
...
// Keep the other existing components (ApplicationsSection, ProfileSection, ResourcesSection) the same as before
