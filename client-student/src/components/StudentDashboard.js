...
// Dashboard Home Component with Updated Quick Actions
...
// Documents Section Component - Updated to use new structure
        ...
        <div className="documents-info">
          ...
          <div className="info-cards">
            <div className="info-card">
              ...
              <p>Official document showing your enrolled courses, schedule, and units for the current semester. Required for validation and official purposes.</p>
            </div>
            <div className="info-card">
              <h5>Certificate of Grade</h5>
              <p>Detailed grade report showing your academic performance. Includes GPA calculation and can be generated for specific semesters or cumulatively.</p>
            </div>
            <div className="info-card">
              <h5>Transcript of Records (TOR)</h5>
              <p>Complete academic history including all courses taken, grades received, and official academic standing. Often required for transfers and employment.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="profile-editor">
          ...
          <div className="profile-actions">
            {isEditing ? (
              ...
              <button className="btn-confirm" onClick={() => setIsEditing(true)}>
                Edit Profile
              </button>
            )}
          </div>
